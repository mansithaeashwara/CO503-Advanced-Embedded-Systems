...
# Memory: onchip_instr_mem_0
MEM_0 := MPSoC_onchip_instr_mem_0
$(MEM_0)_NAME := onchip_instr_mem_0
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_instr_mem_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_instr_mem_0
onchip_instr_mem_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
