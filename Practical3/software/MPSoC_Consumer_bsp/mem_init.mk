...
# Memory: onchip_instr_mem_1
MEM_0 := MPSoC_onchip_instr_mem_1
$(MEM_0)_NAME := onchip_instr_mem_1
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_instr_mem_1
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_instr_mem_1
onchip_instr_mem_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_shared_memory
MEM_1 := MPSoC_onchip_shared_memory
$(MEM_1)_NAME := onchip_shared_memory
...
$(MEM_1)_END := 0x0003ffff
$(MEM_1)_HIERARCHICAL_PATH := onchip_shared_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_shared_memory
onchip_shared_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
